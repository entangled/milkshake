...
-- ~\~ begin <<docs/milkshake.md|src/Milkshake/Data.hs>>[0]
...
-- ~\~ begin <<docs/milkshake.md|haskell-types>>[0]
...
-- ~\~ end
-- ~\~ begin <<docs/milkshake.md|haskell-types>>[1]
...
-- ~\~ end
-- ~\~ begin <<docs/milkshake.md|haskell-types>>[2]
...
-- ~\~ end
-- ~\~ begin <<docs/milkshake.md|haskell-types>>[5]
...
-- ~\~ end
-- ~\~ begin <<docs/milkshake.md|haskell-types>>[6]
data Watch = Watch
    { paths :: [Text]
    , target :: Target
    } deriving (Generic)
